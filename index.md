...
layout: landing
title: PANDAUDIT
subtitle: Fun, practical data analytics for the finance field
---
...
## What kind of finance mess are we solving?

<div class="pandaudit-card-grid fun-grid">
  <div class="pandaudit-card"><h3>Reconciliation riddles</h3><p>Two files enter. Exceptions, matches, and timing differences come out clearly labeled.</p></div>
  <div class="pandaudit-card"><h3>Close-cycle cleanup</h3><p>Turn the monthly copy/paste ritual into a documented workflow with control totals.</p></div>
  <div class="pandaudit-card"><h3>Dashboard ingredients</h3><p>Before the chart, fix the source: fields, dates, amounts, duplicates, and review notes.</p></div>
  <div class="pandaudit-card"><h3>Audit trail treasure maps</h3><p>Follow the source file, the rule, the exception, and the final workpaper.</p></div>
</div>

## The rules of the road

1. **Start with the finance question.** What decision, control, or review are we supporting?
2. **Name the source.** Export, workbook, billing file, ledger, forecast, or report.
...
Browse the [blog]({{ '/blog/' | relative_url }}) for practical examples and bite-sized challenges. PANDAUDIT should feel like a map, not a manual.
